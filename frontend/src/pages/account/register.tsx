                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="relative">
                            <input 
                                ...
                                className={`p-3 pr-12 w-full bg-white rounded-md outline outline-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-600 ${errors.password_confirmation && "outline-red-500 outline-2"}`} 
                            />
                            <div   
                                className={`absolute top-1/2 right-0 -translate-1/2 cursor-pointer transition-transform duration-200 active:scale-90 ${
                                    showPasswordConfirmationField ? "scale-110" : "scale-100"
                                }`}
                                onClick={() => setShowPasswordConfirmationField(!showPasswordConfirmationField)}
                            >
